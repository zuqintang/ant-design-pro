...
@Form.create()
export default class ValueMeaningForm extends PureComponent {
  handleSubmit = (e) => {
    e.preventDefault();
  ...
  render() {
    ...
    return (
      <PageHeaderLayout title="值含义" content="一个值的含义或语义内容。">
        <Card bordered={false}>
          <Form
          ...
          >
            ...
            <FormItem
              ...
              label="描述"
            >
              {getFieldDecorator('GOLD_DESCRIPTION', {
                rules: [{
